...
public class LoginPanel extends JPanel {
	...
	public LoginPanel() {
		...
		springLayout.putConstraint(SpringLayout.NORTH, txfPassword, 0, SpringLayout.SOUTH, txfUsername);
		springLayout.putConstraint(SpringLayout.WEST, txfPassword, 0, SpringLayout.WEST, txfUsername);
		...
		springLayout.putConstraint(SpringLayout.BASELINE, lblPassword, 0, SpringLayout.BASELINE, txfPassword);
		springLayout.putConstraint(SpringLayout.EAST, lblPassword, 0, SpringLayout.WEST, txfPassword);
		
		springLayout.putConstraint(SpringLayout.WEST, btnLogin, 0, SpringLayout.WEST, txfUsername);
		springLayout.putConstraint(SpringLayout.NORTH, btnLogin, 0, SpringLayout.SOUTH, txfPassword);
