...
public class JCalendar extends JPanel {
    ...
    static {
        ...
        DAY_OF_WEEK_LABELS = (String[]) dayList.toArray(new String[7]);
    }
    ...
    private HashMap dateHighlightMap = new HashMap();
            ...
            for (int iColumn = 0; iColumn < 8; iColumn++) {
                ...
                if (iRow == 0 || iColumn == 0) {
                    ...
                    if (dateHighlightMap.get(dateObject) != null) {
                        Color color = (Color) dateHighlightMap.get(dateObject);
                        g.setColor(color);
                        g.fillRect(x, y, w, h);
                    }
    ...
    public Color getDateHighlight(Date date) {
        BasicDate basicDate = new BasicDate(date);
        return (Color) dateHighlightMap.get(basicDate);
    }
